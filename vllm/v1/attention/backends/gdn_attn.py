    ...
    def build(  # type: ignore[override]
        ...
        if not self.use_spec_decode or num_decode_draft_tokens_cpu is None:
            ...
            if (
                ...
                # [FORK-preserved upstream #53077] every scheduled draft
                # count in this batch is zero (e.g. an all-stale-async-row
                # step): num_spec_decodes must be reset alongside
                # spec_sequence_masks{,_cpu} or downstream invariants
                # (num_decodes == num_spec_decodes) can assert-fail.
                num_spec_decodes = 0
                spec_sequence_masks = None
